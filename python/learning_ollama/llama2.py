"""
Llama 2 is good at text generation, question answering 
and text classification due to its large dataset

Llama 2 is a collection of foundation language models 
